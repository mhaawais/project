    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* CHANGED: removed justify-between so we can control left group */}
          <div className="flex items-center h-[72px]">
            ...
            <div className="flex items-center">
              ...
              {/* Desktop Navigation (moved left, next to logo) */}
              <div className="hidden md:flex items-center gap-8 ml-10">
                {navLinks.map((link) => (
                  <a
                    key={link.label}
                    href={link.href}
                    className="text-rv-text-secondary hover:text-[#932a1c] text-sm font-medium transition-colors duration-200 relative group"
                  >
                    {link.label}
            ...
            {/* RIGHT: CTA pushed to far right (desktop only) */}
